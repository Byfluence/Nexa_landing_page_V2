        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <FooterSection title="Contact">
            <ul className="space-y-4">
              ...
              <li>
                <a href="tel:+251 932 00 5810" className="flex items-center text-gray-400 hover:text-white transition-colors">
                  <Phone className="w-5 h-5 mr-2" />
                  +251 957 56 9292
                </a>
              </li>
               <li>
                <a href="tel: +251 751 04 040" className="flex items-center text-gray-400 hover:text-white transition-colors">
                  <Phone className="w-5 h-5 mr-2" />
                  +251 957 58 9797
                </a>
              </li>
